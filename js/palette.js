...
(() => {
    ...
    const PAGES = [
        ...
        { title: 'Literature', sub: 'Reading now, calendar, shelf, reviews', url: 'literature.html' },
        { title: 'Every Book', sub: 'Every cover, searchable by title and author', url: 'books.html' },
