window.BLOG_POSTS = [
  {
    title: 'Frodo, Sam, and love.',
    date: '2026-07-02',
    tags: ['books', 'philosophy', 'personal'],
    excerpt: 'A queer-friendly reading of Frodo and Sam: not a hidden romance, but male friendship deep enough for tears, touch, and total trust. Insisting that tenderness must be romance rebuilds the exact wall this story tears down. (Gimli and Legolas, on the other hand...)',
    url: 'blog/frodo-sam-and-love.html',
    image: 'https://www.john-howe.com/portfolio/gallery/data/media/21/134-End-of-the-Third-port.jpg'
  },
  {
    title: 'Optimizing Your Schedule II (or: When Hours Aren&#39;t the Thing You Run Out Of)',
    date: '2026-06-30',
    tags: ['personal', 'data science', 'advice'],
    excerpt: 'A reply to Part I: time is not the only budget. Energy is a second, renewable resource that some activities spend and others restore. A working model of a depleted week, and why rest is production, not indulgence.',
    url: 'blog/optimizing-your-schedule-ii.html',
    image: 'img/photography/thumb/488.webp'
  },
  {
    title: 'What We Leave Behind',
    date: '2026-06-27',
    tags: ['personal', 'philosophy', 'science'],
    excerpt: 'From the plutonium in the planet&#39;s crust to the Golden Record in interstellar space to the memory of a Tuesday coffee, a look at everything we leave behind, and why none of us ever truly vanishes.',
    url: 'blog/what-we-leave-behind.html',
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/The_Sounds_of_Earth_Record_Cover_-_GPN-2000-001978.jpg'
  },
  {
    title: 'Optimizing Your Schedule (or: Treating Your Week Like a Solvable Problem)',
    date: '2026-06-15',
    tags: ['personal', 'data science', 'advice'],
    excerpt: 'What an operations researcher actually means by optimizing a schedule: objectives, constraints and weightings, a values clarification grid, and a working integer-programming model of your week. Nerd mode optional.',
    url: 'blog/optimizing-your-schedule.html',
    image: 'img/photography/thumb/493.webp'
  },
  {
    ...
    image: 'https://github.com/DrKenReid/DrKenReid.github.io/releases/download/photos-v1/43.png'
  },
  {
  ...
  },
  {
    ...
    excerpt: 'The batteries in our phones, laptops, and EVs are largely made of cobalt mined in the Democratic Republic of the Congo, often by hand and often by children. A reflection on a presentation I gave, and what we can actually do about it.',
    url: 'blog/hidden-cost-of-cobalt-congo.html',
    image: 'img/photography/thumb/384.webp'
  },
  {
    title: 'ISO 8601 and the Date Cult I Happily Joined',
    date: '2026-05-12',
    tags: ['technology'],
    excerpt: 'A playful, half-joking ode to ISO 8601 (YYYY-MM-DD) as the only sortable, unambiguous, international date format worth using.',
    url: 'blog/iso-8601-date-cult.html',
    image: 'img/bg-img/cult_of_ISO8601.png'
  },
  {
  ...
  {
    title: 'Book Ratings Are Broken',
    date: '2026-04-12',
    tags: ['books'],
    excerpt: '569 books rated, and the star system fails at all of them. A data-driven look at my own Goodreads ratings, review lengths, genre bias, and the silence problem.',
    url: 'blog/rating-systems.html',
    image: 'blog/img/rating_distribution.png'
  },
  {
    title: 'Why Most Self-Help Books Are Trash (And Which Ones Aren\'t)',
    date: '2026-04-11',
    tags: ['books'],
